...
/**
 * Utility class for managing HTTP sessions in the SkinHub e-commerce application.
...
public class SessionUtil {
     ...
     */
    public static void setSessionTimeout(HttpServletRequest request, int timeout) {
        HttpSession session = request.getSession();
